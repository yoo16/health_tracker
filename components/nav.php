<nav class="sticky top-0 z-50 bg-white/95 backdrop-blur-sm shadow-sm border-b border-sky-100">
    <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <ul class="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
            ...
            <li>
                <a href="create_database.php" class="relative py-1 transition hover:text-sky-600
                    after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0
                    after:bg-sky-500 after:transition-all hover:after:w-full">
                    DB管理
                </a>
    ...
    <div id="nav-mobile" class="hidden md:hidden border-t border-sky-100 bg-white px-6 py-4">
        <ul class="flex flex-col gap-4 text-sm font-medium text-slate-600">
            ...
            <li><a href="health/add.php" class="block py-1 hover:text-sky-600">新規記録</a></li>
            <li><a href="dashboard/" class="block py-1 hover:text-sky-600">ダッシュボード</a></li>
            <li><a href="activity/" class="block py-1 hover:text-sky-600">アクティビティ</a></li>
            <li><a href="meal/" class="block py-1 hover:text-sky-600">食事</a></li>
            <li><a href="health/chart.php" class="block py-1 hover:text-sky-600">グラフ</a></li>

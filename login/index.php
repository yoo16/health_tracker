        ...
        <section class="mx-auto grid max-w-5xl overflow-hidden rounded-2xl border border-sky-100 bg-white shadow-xl shadow-sky-100/70 md:grid-cols-[0.95fr_1.05fr]">
            ...
            <div class="p-8 md:p-10">
                <div class="mb-8">
                    ...
                    <p class="mt-2 text-sm text-slate-500">登録済みのメールアドレスとパスワードを入力してください。</p>
                </div>
                ...
                <form action="<?= BASE_URL ?>login/auth.php" method="post" class="space-y-5">
                    ...
                    <div class="flex flex-col gap-3 pt-3 sm:flex-row">
                        ...
                        <a href="<?= BASE_URL ?>register/" class="w-full rounded-lg border border-sky-200 bg-white px-6 py-3 text-center text-sm font-bold text-sky-700 transition hover:bg-sky-50">
                            新規登録
                        </a>
                    </div>
                </form>
